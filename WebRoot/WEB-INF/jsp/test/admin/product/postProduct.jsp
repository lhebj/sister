...
<body>
		...
		<table>
			...
			<tr>
				...
				<td><input name="namePrd" type="text"
					...
					value="${productDTO.namePrd}" /></td>
			</tr>
			<tr>
				<td width='60'>产品信息</td>
				<td><input name="infoPrd" type="text"
					style="width:900px;height:30px"
					value="${productDTO.infoPrd}" /></td>
			</tr>
			<tr>
	...
	<script src="assets/js/sister/productdl.js"></script>
