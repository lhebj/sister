...
<script>
	$(function() {
		$(".moduletable-banner").mouseenter(function() {
			$(".ad-text").fadeIn(500);
...
<body class="bg_img">
	...
	<div class="row2">
		...
		<div class="moduletable-banner">
			<div class="ad-text" style="height: 570px; display:none;">
			...
			<div class="flexslider">
				<ul class="slides">
					<c:forEach items="${productPicDTOList}" var="productPicDTO">
						<li><a href="#"> <img src="${productPicDTO.picPathPrdp}" alt="${productPicDTO.picNamePrdp}" onload="imagezoom.call(this, 1054, 621);" /></a></li>
					</c:forEach>
				</ul>
			</div>
		</div>
	...
	<div class="row3">
		...
		<img onmousedown="ISL_GoUp()" onmouseup="ISL_StopUp()"
			onmouseout="ISL_StopUp()" class="img2" src="<%=IMAGE_PATH%>ad_scroll_back.png" />
