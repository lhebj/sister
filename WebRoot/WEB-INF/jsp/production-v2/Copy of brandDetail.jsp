...
<body class="bg_img">
	...
	<div class="row2">
		...
		<div class="moduletable-banner-product">
			<div class="ad-text" style="height:374px; overflow:hidden; display:none;">
			...
			<div class="flexslider">
				<ul class="slides">
					<c:forEach items="${productPicDTOList}" var="productPicDTO">
						<li><a href="#"> <img src="${productPicDTO.picPathPrdp}" alt="${productPicDTO.picNamePrdp}" onload="imagezoom.call(this, 876, 424);" /></a></li>
					</c:forEach>
				</ul>
			</div>
		</div>
...
<div class="rollBox">
     ...
     <div class="Cont" id="ISL_Cont">
      <div class="ScrCont">
       <div id="List1">
        <!-- 图片列表 begin -->
        <div class="pic">
          <a href="#" target="_blank"><img src="<%=IMAGE_PATH%>show_1.jpg"  width="175" height="85"></a> 
         </div>
      <div class="pic">
          <a href="#" target="_blank"><img src="<%=IMAGE_PATH%>show_1.jpg"  width="175" height="85"></a>
    ...
    <img onmousedown="ISL_GoUp()" onmouseup="ISL_StopUp()" onmouseout="ISL_StopUp()" class="img2" src="<%=IMAGE_PATH%>ad_scroll_back.png" />
    <img onmousedown="ISL_GoDown()" onmouseup="ISL_StopDown()" onmouseout="ISL_StopDown()" class="img1" src="<%=IMAGE_PATH%>ad_scroll_forward.png" />
</div>
<!--row3-->
