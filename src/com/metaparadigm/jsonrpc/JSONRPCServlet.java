 ...
 * JSONRPCBridge instance registered in the HttpSession.
 * </p>
 * By default, the JSONRPCServlet places an instance of the JSONRPCBridge object
 * is automatically in the HttpSession object registered under the attribute
 * "JSONRPCBridge".
 * <p />
 ...
 * 
 * <p />
 * You can disable the automatic creation of a JSONRPCBridge in the session by
 * placing the XML below into your web.xml inside the &lt;servlet&gt; element.
 * If you do this, you can add one to the session yourself. If it is disabled,
 * and you have not added one to the session, only the global bridge will be
 * available.
 * <p />
 * 
 * <pre>
 ...
 * </pre>
 * 
 * To disable keepalives to workaround issues with certain web containers and
 * configurations of apache / connectors place the following XML into your
 * web.xml inside the &lt;servlet&gt; element.
 * <p />
 * 
 * <pre>
 * &lt;init-param&gt;
