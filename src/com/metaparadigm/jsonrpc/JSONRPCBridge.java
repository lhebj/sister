 ...
 * JSONRPCServlet.
 * <p />
 * The bridge is implemented as session specific to improve the security of
 * applications by allowing exporting of object methods only to specific
 * HttpSessions.
 * <p />
 * To use the bridge to allow calling of Java methods you can easily access the
 * HttpSession specific bridge in JSP using the usebean tag. eg.
 * <p />
 ...
 * specific objects to clients that are authorised to use them.
 * <p />
 * There exists a global bridge singleton object that will allow exporting
 * objects to all HTTP clients. This can be used for registering factory classes
 * although care must be taken with authentication as these objects will be
...
public class JSONRPCBridge implements Serializable {
	 ...
	 * 
	 * @param name
	 *            The named prefix to export the class as
	 * @param clazz
	 ...
	 * 
	 * This can be used to restrict the exported methods to the methods defined
	 * in a specific superclass or interface.
	 */
